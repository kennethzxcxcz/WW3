...
const DATA = {
  ...
  R5: { t: 'R', n: "Indo-Pakistani Conventional Border Escalation Level", txt: "LOC ceasefire violation frequency, forward deployment of Strike Corps, cross-border artillery exchange intensity, and Balakot-style air incursion probability. High = conventional war imminent in South Asia.", val: 0.50 },
  ...
  R10: { t: 'R', n: "Global Sovereign Debt, Banking Fragility & Systemic Financial Risk", txt: "Composite of G20 debt-to-GDP trend, U.S. deficit financing stress, Japanese JGB yield curve control collapse risk, European sovereign spread widening, and shadow banking exposure to geopolitical shocks. High = a geopolitical shock could trigger a 2008-magnitude or worse financial cascade.", val: 0.55 },
  R11: { t: 'R', n: "Lethal Autonomous Weapons (LAWS) Proliferation & AI-Enabled Warfare Acceleration", txt: "Tracks drone swarm AI deployment by non-state actors, AI-enabled target selection without human authorization in active theaters, deepfake command-and-control spoofing incidents, and failure of international LAWS governance frameworks. High = autonomous systems may execute escalatory actions without human decision.", val: 0.30 },
  R12: { t: 'R', n: "Arctic Militarization, Resource Competition & Northern Sea Route Conflict", txt: "Composite of Russian Arctic military base expansion, Norwegian/Finnish/Swedish NATO Arctic integration, Chinese Arctic research-to-dual-use base conversion, and control disputes over exclusive economic zones in the Barents/Beaufort. High = Arctic becomes a viable secondary military theater.", val: 0.25 },
  R13: { t: 'R', n: "Strategic Disinformation, Deepfake Operations & Epistemic Infrastructure Collapse", txt: "Tracks state-sponsored deepfake video incidents targeting heads of state, AI-generated false flag attack claims, social media coordinated inauthentic behavior scale, and public institutional trust collapse indices in G7 nations. High = decision-makers and publics cannot distinguish real attacks from fabricated ones.", val: 0.50 },
  R14: { t: 'R', n: "Simultaneous Breadbasket Climate Shock Severity", txt: "Probability of concurrent crop failure in 3+ major agricultural regions (U.S. Midwest, Indian subcontinent, Sub-Saharan Africa, Chinese plains) driven by climate extremes within a 12-month window. High = food shock is sudden, severe, and geographically distributed.", val: 0.30 },
  R15: { t: 'R', n: "Nuclear Doctrine Normalization & Tactical Nuclear Use Threshold Erosion", txt: "Tracks changes in Russian nuclear doctrine (lowered first-use threshold since 2022), Israeli ambiguity erosion signals, Pakistani battlefield nuclear doctrine, and public statements by heads of state normalizing tactical nuclear weapons as \\\"usable.\\\" High = the taboo on nuclear use has materially weakened.", val: 0.30 },

  I1: { t: 'I', n: "GCC Critical Infrastructure Destruction", deps: { R1: 0.90, R2: 0.90 }, txt: "Interceptor failure combined with high IRGC launch capacity results in successful strikes on Saudi Aramco facilities, UAE desalination plants, and Bahrain's 5th Fleet infrastructure. Triggers GCC state fragility." },
  I2: { t: 'I', n: "Strait of Hormuz Closure & Global Energy Shock", deps: { R1: 0.70, R2: 0.90, R4: 0.45 }, txt: "IRGC naval capacity enables mine-laying and suicide boat attacks on tanker traffic. BRICS financial backing sustains Iran through counter-pressure, extending the closure window. 20% of global oil transits this chokepoint." },
  I3: { t: 'I', n: "European Energy & Industrial Supply Chain Collapse", deps: { I2: 0.85, R7: 0.55 }, txt: "Hormuz closure plus continued disruption of Caspian/Baltic energy from the Ukraine war eliminates remaining European energy diversification buffers, forcing industrial shutdowns and winter humanitarian crises." },
  I4: { t: 'I', n: "Space/ASAT Warfare, ISR Blindness & GPS Degradation", deps: { R1: 0.25, R4: 0.45, R8: 0.75 }, txt: "Failing terrestrial defense forces reliance on space-based early warning, which China and Russia (with BRICS EW support) target via co-orbital ASAT, directed energy, and GPS spoofing. Loss of ISR creates compellence vacuum." },
  I5: { t: 'I', n: "Middle East & Levant Regional Proxy Surge", deps: { R1: 0.45, R2: 0.80, I1: 0.60 }, txt: "IRGC activates the Axis of Resistance simultaneously: Hezbollah (Lebanon), Houthis (Red Sea), PMF (Iraq), PIJ (Gaza), and Syrian remnants. Coordinated surge exploits GCC infrastructure chaos as strategic distraction." },
  I6: { t: 'I', n: "South Asian Kinetic Escalation & Conventional War", deps: { R5: 0.90, I5: 0.30 }, txt: "Baseline Pakistan-India border tension ignited by regional proxy activity drawing U.S. attention away from South Asia. Pakistani army, facing internal pressure, miscalculates a cross-border strike." },
  I7: { t: 'I', n: "Subsea Cable Sabotage & Global Internet Infrastructure Attack", deps: { I2: 0.25, I4: 0.50, R13: 0.30 }, txt: "Maritime blockade in Hormuz/Red Sea provides operational cover for Russian/Chinese naval assets to cut Atlantic and Indo-Pacific undersea cables. ISR blindness prevents attribution. 95% of intercontinental internet runs on subsea cables." },
  I8: { t: 'I', n: "Global Financial Contagion, SWIFT Disruption & Market Crash", deps: { R10: 0.85, I7: 0.70, R4: 0.45 }, txt: "Internet infrastructure damage disrupts SWIFT messaging and exchange settlement systems. Pre-existing sovereign debt fragility amplifies the shock into a full banking contagion. BRICS parallel systems lack the depth to substitute." },
  I9: { t: 'I', n: "Mass Famine, Displacement & Refugee Crisis", deps: { R6: 0.50, R14: 0.75, I8: 0.70, I17: 0.55 }, txt: "Agricultural fragility and climate shock, supercharged by financial collapse destroying import capacity, triggers acute famine in import-dependent nations (Egypt, Yemen, Pakistan, Ethiopia). 500M+ people at acute food insecurity." },
  I10: { t: 'I', n: "Taiwan Strait Hot Incident — Naval / Aerial Clash", deps: { R8: 0.85, I4: 0.45 }, txt: "Chinese gray-zone operations escalate to kinetic exchange: a PLAN vessel collides with or fires on a USN/ROC Navy ship, or a PLA J-20 engages an ROC F-16 in the median line. The incident crosses the threshold of armed conflict." },
  I11: { t: 'I', n: "Korean Peninsula Crisis Activation", deps: { R9: 0.80, I10: 0.50 }, txt: "North Korea exploits U.S. Pacific Command distraction during Taiwan crisis to conduct provocative ICBM test over Japan, nuclear artillery exercise near DMZ, or a limited KPA incursion into the DMZ buffer zone." },
  I12: { t: 'I', n: "Arctic Military Incident & Northern Theater Activation", deps: { R12: 0.85, R7: 0.65, I16: 0.40 }, txt: "Russian Arctic forces, emboldened by NATO distraction in Ukraine and backed by China's dual-use Arctic infrastructure, conduct a physical seizure of a contested islet or energy platform, drawing Scandinavian NATO members into direct confrontation." },
  I13: { t: 'I', n: "Nuclear Alert / False Flag Misattribution & Crisis Misperception", deps: { I4: 0.70, R13: 0.90, R15: 0.75, R11: 0.35 }, txt: "ISR degradation and deepfake operations produce a false-positive nuclear launch detection, or a synthetic video of a head of state ordering nuclear use goes viral before it can be debunked. Decision windows collapse from hours to minutes." },
  I14: { t: 'I', n: "Global Internet Fragmentation, Comms Blackout & Governance Collapse", deps: { I7: 0.80, R13: 0.70, I4: 0.35 }, txt: "Subsea cable cuts plus coordinated cyberattacks on tier-1 internet exchange points produce regional internet islands. Loss of real-time communication collapses diplomatic back-channels and UN Security Council rapid-response mechanisms." },
  I15: { t: 'I', n: "Autonomous Weapon Unauthorized Escalatory Engagement", deps: { R11: 0.85, I4: 0.70, I13: 0.50, I14: 0.45 }, txt: "An AI-enabled drone swarm or autonomous naval mine system, operating under degraded GPS and command communications, misidentifies a civilian target or allied asset as an enemy combatant and executes a lethal strike, triggering a counter-response before the error can be communicated." },
  I16: { t: 'I', n: "NATO Internal Fracture, Article 5 Credibility Crisis & Alliance Solidarity Breakdown", deps: { R3: 0.70, R7: 0.55, I3: 0.65, R13: 0.30 }, txt: "U.S. domestic paralysis signals unreliable extended deterrence. European allies facing energy collapse disagree on acceptable risk. Hungary/Slovakia veto mechanisms exploit Article 5 consultation thresholds, fracturing collective response." },
  I17: { t: 'I', n: "Global Shipping, Trade Route & Supply Chain Collapse", deps: { I2: 0.70, I7: 0.55, I10: 0.60, I5: 0.45 }, txt: "Hormuz closure eliminates the Persian Gulf route; Taiwan crisis threatens South China Sea lanes; cable sabotage disrupts container booking systems. Red Sea (Houthi), Malacca, and Cape of Good Hope routes simultaneously stressed." },
  I18: { t: 'I', n: "Petrodollar Collapse, Reserve Currency War & Sovereign Wealth Liquidation", deps: { R4: 0.70, I2: 0.80, I8: 0.65 }, txt: "Sustained Hormuz closure breaks the implicit petrodollar compact as Saudi Arabia sells oil in yuan. Simultaneous SWIFT disruption accelerates dollar exodus. Central banks begin emergency dollar-asset liquidation, triggering UST yield spike." },
  I19: { t: 'I', n: "Weapons of Mass Destruction Deployment by Non-State Actors", deps: { R2: 0.45, I5: 0.70, R13: 0.50 }, txt: "IRGC-backed proxy groups, exploiting attribution confusion created by disinformation operations, deploy weaponized chemical agents (e.g., modified Novichok analogs) or engineered biological material in a population center, crossing a red line that historically triggers massive state retaliation." },
  I20: { t: 'I', n: "State Fragility Cascade & Multi-State Collapse in MENA/Sub-Saharan Africa", deps: { I9: 0.70, I5: 0.55, I8: 0.50, I17: 0.45 }, txt: "Famine, proxy violence, and financial collapse simultaneously destabilize nuclear-adjacent states (Pakistan), Gulf monarchies (Saudi Arabia), and African swing states, producing ungoverned space, weapons proliferation, and mass refugee flows that overwhelm European and South Asian borders." },

  E1: { t: 'E', n: "NATO Article 5 Formal Invocation & Collective Defense Mobilization", deps: { I5: 0.60, I7: 0.75, I16: 0.25, I12: 0.35 }, txt: "Proxy surge striking Cyprus, Italy, or Baltic NATO members (I5), combined with European internet blackout via cable sabotage (I7), overcomes the alliance fracture (I16) with a clear armed-attack determination. NATO formally enters the conflict." },
  E2: { t: 'E', n: "Russian Direct Major Military Intervention in NATO Theater", deps: { I4: 0.70, E1: 0.85, R7: 0.75, I12: 0.45 }, txt: "Successful ISR blindness (I4) removes the detection deterrent on Russian strike packages. A formally invoked but fractured NATO (E1) appears to Moscow as a paper tiger. Russia conducts direct conventional strikes on NATO logistics nodes in Poland or Romania." },
  E3: { t: 'E', n: "Chinese PLA Taiwan Blockade / Amphibious Invasion Initiation", deps: { R3: 0.55, E2: 0.65, I10: 0.85, R8: 0.50 }, txt: "U.S. domestic paralysis (R3) degrades credible extended deterrence signaling. Russian engagement (E2) consumes EUCOM/NORTHCOM bandwidth. The Taiwan Strait hot incident (I10) provides a pretext for escalation to a full blockade enforced by PLAN." },
  E4: { t: 'E', n: "Nuclear / Unconventional Weapons Employment", deps: { R1: 0.55, I1: 0.55, I5: 0.45, R15: 0.90, I13: 0.75, I15: 0.45, I6: 0.55 }, txt: "The convergence of complete interceptor failure, burning GCC infrastructure, overwhelming proxy pressure, eroded nuclear taboo, and a misperception crisis created the first battlefield nuclear employment since 1945. The Samson Option (Israel), Pakistani tactical nuclear use in a South Asian war, or a Russian \\\"demonstration strike\\\" all qualify." },
  E5: { t: 'E', n: "Global Food System Collapse & Synchronized Famine Event", deps: { R6: 0.50, I9: 0.85, I17: 0.70, R14: 0.55 }, txt: "Baseline agricultural fragility (R6), already producing acute famine (I9), is converted into a systemic multi-region collapse as global shipping failure (I17) ends food aid delivery. UN World Food Programme exhausts reserves. Mortality exceeds 10M within 12 months." },
  E6: { t: 'E', n: "Global Financial System Collapse & Great Depression II", deps: { I8: 0.85, I18: 0.75, E5: 0.45, I17: 0.50 }, txt: "Financial contagion (I8) and petrodollar collapse (I18) converge. The Federal Reserve loses reserve currency credibility. A synchronized G20 bank run produces a credit freeze exceeding 2008. Global GDP contracts >15% within 24 months." },
  E7: { t: 'E', n: "Korean Peninsula Nuclear War Activation", deps: { I11: 0.75, E3: 0.70, R9: 0.85, I13: 0.35 }, txt: "Korean crisis (I11) escalates beyond the DMZ as PACOM is consumed by the Taiwan emergency (E3). Kim Jong-un, calculating existential threat from U.S. retaliation regardless, authorizes nuclear-armed SCUD/KN-24 employment against USFK/Camp Humphreys. Japan and South Korea face existential decisions about their own deterrents." },
  E8: { t: 'E', n: "Multi-Theater Simultaneous Great Power War Activation", deps: { E1: 0.70, E2: 0.85, E3: 0.85, E7: 0.65 }, txt: "Three simultaneous active great-power fronts: NATO-Russia in Europe, U.S.-China in the Pacific, and the Middle East proxy war metastasizing into direct U.S.-Iran kinetic conflict. No precedent exists for three-front great-power war in the nuclear age. Command authority and strategic doctrine break down under simultaneous demand." },
  E9: { t: 'E', n: "Eurasia-MENA Multi-State Collapse & Nuclear Proliferation Emergency", deps: { I9: 0.55, E5: 0.65, I20: 0.80 }, txt: "State fragility cascade produces ungoverned space in Pakistan (nuclear), Saudi Arabia (chemical), and the Sahel (French-abandoned enrichment material). Nuclear/radiological material falls outside command-and-control. Non-state nuclear employment becomes credible for the first time." },
  E10: { t: 'E', n: "Full-Spectrum Space War & Satellite Kill Chain Activation", deps: { I4: 0.85, E2: 0.70, E3: 0.65 }, txt: "Russia and China activate full ASAT campaigns, destroying GPS, Starlink, and military communication constellations. Loss of satellite infrastructure collapses precision weapons, real-time targeting, and nuclear command-and-control uplinks — creating use-it-or-lose-it pressure on nuclear forces." },
  E11: { t: 'E', n: "Autonomous AI Escalation Beyond Human Control & Decision Loop Collapse", deps: { I15: 0.75, E4: 0.55, E10: 0.70, I14: 0.50 }, txt: "The combination of autonomous weapon incidents (I15), nuclear use normalization (E4), and space/comms blackout (E10) produces a theater where AI systems are operating without human-in-the-loop authorization, executing retaliatory strikes faster than human decision cycles. The Fog of War is now algorithmic." },
  E12: { t: 'E', n: "WMD Non-State / Proxy Escalation & Chemical-Biological Mass Casualty Event", deps: { I19: 0.85, E9: 0.75, I5: 0.45, I20: 0.50 }, txt: "Non-state actors (IRGC proxies, ISIS remnants benefiting from state collapse) deploy WMD in a major population center — chemical agent in a subway system (Tokyo, London, New York) or engineered pathogen released at a crowded international border crossing. This generates public pressure for massive conventional or nuclear retaliation regardless of clean attribution." },

  T1: { t: 'T', n: "WORLD WAR III — Global Systemic War", deps: { E1: 0.55, E2: 0.75, E3: 0.75, E4: 0.80, E7: 0.60, E8: 0.95, E10: 0.55, E11: 0.60, E12: 0.45 }, txt: "Defined as: the simultaneous engagement of at least two nuclear-armed great powers in direct kinetic conflict across three or more geographic theaters, with civilian casualties exceeding one million and no credible ceasefire mechanism in operation. This is not merely a large war — it is the failure of the entire post-1945 deterrence architecture." }
};


const TIER_LEAKS = { I: 0.00, E: 0.00, T: 0.00 };
